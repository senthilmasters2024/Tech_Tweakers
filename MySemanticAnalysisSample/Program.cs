...
namespace MySemanticAnalysisSample
{
    internal class Program
    {
        ...
        //            var embedding = await embeddingGenerator.CreateEmbedding(domain);
        //            domainEmbeddingDictionary.Add(domain, embedding);
        //        }
        //        var similarityCalculator = new CosineSimilarityCalculator();

        //        foreach (var inputText in inputTexts) {
        //            //preprocess
        //            var embedding = await embeddingGenerator.CreateEmbedding(inputText);
        ...
        //                Console.WriteLine(inputText + "," + domainEmbedding.Key + "->" + similarity);  //write to csv
