...
### **Project Requirement**
In this project, students must leverage OpenAI's GPT to create embeddings for a set of documents. The solution should utilize the OpenAI NuGet package, as demonstrated in OpenAI Samples.
...
1. **Data Visualization**
   - Generate CSV files containing similarity metrics for external tools like Microsoft Excel or Tableau.
...
2. **Reproducible Codebase**
   ...
   - Ensure the code is well-documented and exports results in CSV format for further processing.
3. **Methodology Documentation**
   - Clearly document the methods and algorithms used for semantic similarity computation.
   - Explain the choice of metrics (e.g., cosine similarity, embeddings) and pre-trained models (e.g., Word2Vec, BERT).
